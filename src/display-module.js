...
const renderArray = (element, array) => {
  ...
  array.forEach((object, index) => {
    ...
    object.status === 'undone'
      ? titleSpan.setAttribute('class', 'taskTitle')
      : titleSpan.setAttribute('class', 'taskTitle strikeText');
    titleSpan.innerText = object.title;

    const descriptionSpan = document.createElement('span');
    descriptionSpan.setAttribute('value', index);
    object.status === 'undone'
      ? descriptionSpan.setAttribute('class', 'taskDescription')
      : descriptionSpan.setAttribute('class', 'taskDescription strikeText');
    descriptionSpan.innerText = object.description;

    const checkImage = document.createElement('img');
    object.status === 'undone'
      ? checkImage.setAttribute('src', '../src/images/unmarked_checkbox.png')
      : checkImage.setAttribute('src', '../src/images/marked_checkbox.png');
...
const modifyTaskForm = (
  ...
  formTitleElement.textContent = 'Edit task';
